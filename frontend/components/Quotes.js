...
const dispatch = useDispatch()
  ...
  return (
    <div id="quotes">
            ...
            .map(qt => (
              ...
              >
                ...
                <div className="quote-buttons">
                  ...
                  dispatch(actionToDispatch)/* ✨ dispatch an action */ 
                  }}>DELETE</button>
                  <button onClick={() => {
                    dispatch(setHighlighedQuote(qt.id))/* ✨ dispatch an action */ 
                    }}>HIGHLIGHT</button>
                  <button onClick={() => {
                    dispatch(editQuoteAuthenticity(qt.id))/* ✨ dispatch an action */ 
                    }}>FAKE</button>
                </div>
              </div>
            ))
      ...
      onClick={() => {
        dispatch(toggleVisibility())/* ✨ dispatch an action */ }}>
